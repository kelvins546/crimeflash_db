...
$query = "SELECT * FROM crime_reports WHERE status IN ('assigned', 'on the way')";
        ...
        <div class="navigation-bar">
            ...
            <aside class="sidenav">
                <ul>
                    ...
                    <li>
                        <a href="incident_transferred.php">
                            <i class="fa-solid fa-circle-user"></i>
                            <span>Transferred Reports</span>
                        </a>
                    </li>
                    <li>
                        <form method="post" style="display: inline;">
                            <button type="submit" name="logout" class="fa-solid fa-circle-user">Logout</button>
                        </form>
                    </li>
                </ul>
            </aside>
