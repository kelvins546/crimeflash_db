...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['create_user'])) {
    ...
    $check_email = $conn->prepare("SELECT id FROM clerk_profiles WHERE email = ?");
    ...
    if ($check_email->num_rows > 0) {
        ...
        // insert user
        $stmt = $conn->prepare("INSERT INTO clerk_profiles (name, email, contact_number, address, password) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param("sssss", $name, $email, $contact_number, $address, $password);

        if ($stmt->execute()) {
            $_SESSION['success_message'] = "clerk created successfully!";
        } else {
...
$result = $conn->query("SELECT id, email, name, contact_number, address FROM clerk_profiles");
    ...
    <div class="wrapper">
        ...
        <main class="hero">
            <div class="search-nbtn">
                ...
                <!-- create user button -->
                <button class="btn btn-primary" onclick="openModal()">Create clerk</button>
                ...
                <div id="userModal" class="modal">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="">
                            ...
                            <button type="submit" name="create_user">Create clerk</button>
